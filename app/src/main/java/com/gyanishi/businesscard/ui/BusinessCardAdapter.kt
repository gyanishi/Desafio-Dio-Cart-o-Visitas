...
import com.gyanishi.businesscard.databinding.ItemCardBinding

class BusinessCardAdapter: ListAdapter<BussinessCard, BusinessCardAdapter.ViewHolder>(DiffCallback()) {
...
class DiffCallback:DiffUtil.ItemCallback<BussinessCard>() {
    override fun areItemsTheSame(oldItem: BussinessCard, newItem: BussinessCard) = oldItem == newItem
    override fun areContentsTheSame(oldItem: BussinessCard, newItem: BussinessCard) = oldItem.id == newItem.id
}
